...
const UseMultipleDialog = ({ onClose, snackBarData }) => {
  ...
  const handleAddClick = () => {
    ...
    formik.setFieldValue("quantity", [...formik.values.quantity, ""], true);
    setConfirmationButtons(false);
  };
  ...
  const handleRemoveClick = (index) => {
    ...
    const newQuantity = [...formik.values.quantity];
    newQuantity.splice(index, 1);
    formik.setFieldValue("quantity", newQuantity, true);
  };
            ...
            <Fragment key={index}>
              <Box sx={centerContents}>
                ...
                <Grid
                  ...
                  paddingBottom={0}
                >
                  <Grid container spacing={1} item xs={9} md={10} lg={10}>
                    ...
                    <Grid item marginBottom={1} xs={12} sm={12} md={12} lg={6}>
                      <TextField
                        size="small"
                        helperText={
                          (formik.touched.quantity?.[index] &&
                            formik.errors.quantity?.[index]) ||
                          (formik.touched.quantity?.[index] &&
                          !formik.values.quantity[index]
                        ...
                        fullWidth
                        onClick={() =>
                          formik.setFieldTouched(`quantity[${index}]`, true)
                        }
                        ...
                        error={
                          formik.touched.quantity?.[index] &&
                          Boolean(formik.errors.quantity?.[index])
                        }
                      />
                    </Grid>
                  </Grid>
                  ...
                  <Grid container item xs={2} md={2} lg={2}>
                    ...
                    {index === useItems.length - 1 && (
                      <Grid item xs={1} sm={12} md={6} lg={6}>
